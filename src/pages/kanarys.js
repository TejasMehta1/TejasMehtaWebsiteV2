...
import Kanarys from "../images/kanarys-logo-white.svg"
...
class IndexPage extends React.Component {
  ...
  render(){
    ...
    return (
      ...
      <React.Fragment>
        <LeanHeader/>
        <div style={{height: "40vh", position: "relative", backgroundColor: "#e5911f", backgroundImage: "linear-gradient(315deg, #E5911F 6.9%, #F3B01B 44.3%, #FFCF01  81.3%, #FFD226 97.6%)"}}>
          <div style={{
            backgroundImage: `url(${Kanarys}`,
            height: "40vh",
            backgroundRepeat: "no-repeat",
            backgroundPosition: "center",
            backgroundSize: "calc(20% + 200px)",
          }}/>
        ...
        <div style={{ backgroundColor: "rgba(38,0,71,0.98)" }}>
          ...
          <hr className={"smallWhiteHR"}/>
          <h2 style={{textAlign: "center", color: "white", fontFamily: "Quicksand, sans-serif"}}>VIRTUAL COMMUNITIES | DATA AUTOMATION</h2>


          <p style={{textAlign: "center", color: "white", fontFamily: "Quicksand, sans-serif"}}>PRODUCT SPECIFICATIONS, FIGMA, USER INTERVIEWS, PYTHON, REACT, GOOGLE CLOUD VISION, BASH</p>
          <div className={"dynamicContainer"}>
